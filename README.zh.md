...
[![GitHub 最新版本](https://img.shields.io/github/v/release/wen-wen520/Minecraft.Datapack-Ore_Plus)](https://github.com/wen-wen520/Minecraft.Datapack-Ore_Plus)
![GitHub 发布日期](https://img.shields.io/github/release-date/wen-wen520/Minecraft.Datapack-Ore_Plus)
![GitHub 累计下载](https://img.shields.io/github/downloads/wen-wen520/Minecraft.Datapack-Ore_Plus/total)
![GitHub 星标](https://img.shields.io/github/stars/wen-wen520/Minecraft.Datapack-Ore_Plus?style=flat)
![GitHub 分支](https://img.shields.io/github/forks/wen-wen520/Minecraft.Datapack-Ore_Plus?style=flat)
</div>

## 📋 简介

这个数据包增加了我的世界游戏内原版矿物的生成概率，\
数据包根据不同的增强力度，可分为 x2 x4 和 ultra 版本。
...
### 无需模组加载器：
此数据包基于原版 Minecraft 开发，无需额外的模组加载器。\
当然，你可以选择安装打包的 mod 版本。
...
[Modrinth 上的更多图片](https://modrinth.com/datapack/ore_plus/gallery)

![使用 x2 数据包的矿物生成展示](https://cdn.modrinth.com/data/EvMSt5OU/images/b4b407db79492e3038f7f8089968141314b2e8d8.jpeg)

<br>

![使用 x4 数据包的矿物生成展示](https://cdn.modrinth.com/data/EvMSt5OU/images/f42c4e4799a973adfddc87187760cd2f8d354d9b.jpeg)

<br>

![使用 Ultra 数据包的矿物生成展示](https://cdn.modrinth.com/data/EvMSt5OU/images/9fb254d863a6da3aae71865561b513d5f182ef8e.jpeg)

只有 Ultra 数据包会更改矿物的生成范围，\
你甚至可以在y=60的地平面上挖到钻石！
...
以下表格显示了应用数据包后修改的矿物生成率。

请注意，数据包名称并不直接反映与原版生成率的倍数关系，而是体现了数据包修改原版矿物生成率的程度。



| 矿物种类   | 矿石名称        | 原版生成率 | x2 数据包生成率      | x4 数据包生成率     | Ultra 数据包生成率 |
|:----------:|:---------------:|:------------:|:----------------:|:----------------:|:--------------:|
| Large      | 远古残骸  | 1            | 8                | 16               | 256            |
| Lower      | 煤矿            | 20           | 40               | 80               | 256            |
| Upper      | 煤矿            | 30           | 54               | 100              | 256            |
| Ore        | 铜矿          | 16           | 26               | 48               | 256            |
| Large      | 铜矿          | 16           | 26               | 48               | 256            |
| Small      | 远古残骸          | 1            | 8                | 16               | 256            |
| Ore        | 钻石矿         | 7            | 20               | 40               | 256            |
| Buried     | 钻石矿         | 4            | 12               | 24               | 256            |
| Large      | 钻石矿         | 9            | 24               | 48               | 256            |
| Ore        | 绿宝石矿         | 100          | 160              | 220              | 256            |
| Ore        | 金矿            | 4            | 10               | 20               | 256            |
| Deltas     | 金矿            | 20           | 35               | 80               | 256            |
| Extra      | 金矿            | 50           | 90               | 200              | 256            |
| Lower      | 金矿            | [0,1]        | [6,12]           | [18,24]          | 256            |
| Nether     | 金矿            | 10           | 20               | 40               | 256            |
| Middle     | 铁矿            | 10           | 20               | 40               | 256            |
| Small      | 铁矿            | 10           | 20               | 40               | 256            |
| Upper      | 铁矿            | 90           | 140              | 200              | 256            |
| Ore        | 青金石矿          | 2            | 8                | 20               | 256            |
| Buried     | 青金石矿           | 4            | 12               | 32               | 256            |
| Deltas     | 下界石英          | 32           | 56               | 100              | 256            |
| Nether     | 下界石英          | 16           | 28               | 48               | 256            |
| Ore        | 红石矿        | 4            | 10               | 22               | 256            |
| Lower      | 红石矿        | 8            | 18               | 36               | 256            |


>[!Tip]
>Modrinth 下载页面上也列出了生成概率。

详情请参考 [wiki](https://github.com/wen-wen520/Minecraft.Datapack-Ore_Plus/wiki)，因为不同的版本矿石生成概率会有变化，尤其是1.17 1.18。
...
| 1.21 - 1.21.8      |    ✅    | [⬇️ 数据包](https://modrinth.com/datapack/ore_plus/versions?g=1.21.4&l=datapack)       | [⬇️ 模组](https://modrinth.com/datapack/ore_plus/versions?g=1.21.5&l=fabric)        |
| 1.21.9 - 1.21.11      |    ✅    | [⬇️ 数据包](https://modrinth.com/datapack/ore_plus/versions?g=1.21.9&l=datapack)       | [⬇️ 模组](https://modrinth.com/datapack/ore_plus/versions?g=1.21.9&l=fabric)        |
| 1.21.11 之后       |    ❎    |        |         |
...
游戏版本: `1.21.9 - 1.21.11`\
数据包格式: `88.0 - 94.1`\
**x2** **x4** 和 **Ultra** 可以 [下载 ⬇️](https://modrinth.com/datapack/ore_plus/versions?g=1.21.9)
