...
data modify storage ore_plus:info supported_versions set value ["1.21","1.21.1","1.21.2","1.21.3","1.21.4","1.21.5","1.21.6","1.21.7"]
data modify storage ore_plus:info version set value {"standard":3,"version_number":"2.48.81.1","update":"07/04/2025","build":"8"}
