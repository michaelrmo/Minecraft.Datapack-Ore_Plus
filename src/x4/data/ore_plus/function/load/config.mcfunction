...
data modify storage ore_plus:info supported_formats set value [48,57,61,71,80]
data modify storage ore_plus:info supported_versions set value ["1.21","1.21.1","1.21.2","1.21.3","1.21.4","1.21.5","1.21.6"]
data modify storage ore_plus:info version set value {"standard":3,"version_number":"2.48.80.1","update":"06/18/2025","build":"7"}
