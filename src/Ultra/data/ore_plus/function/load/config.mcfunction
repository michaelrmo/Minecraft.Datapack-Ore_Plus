...
data modify storage ore_plus:info supported_formats set value [48,57,61]
data modify storage ore_plus:info supported_versions set value ["1.21","1.21.1","1.21.2","1.21.3","1.21.4"]
data modify storage ore_plus:info version set value {"standard":3,"version_number":"2.48.61.1","update":"01/17/2025","build":"3"}
